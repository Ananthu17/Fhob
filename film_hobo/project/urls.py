...
urlpatterns = [
     ...
     path('crew-apply-api/', CrewApplyAPI.as_view(),
          name='crew-apply-api'),
     path('crew-application-listing/<int:id>/',
          CrewApplicationListingView.as_view(),
     ...
     path('cast-apply-password-check-api/',
          CastApplyPasswordCheckAPI.as_view(),
     ...
     path('cancel-crew-attach-request-api/',
          CancelCrewAttachRequestAPI.as_view(),
     ...
     path('decline-crew-attach-request-api/',
          DeclineCrewAttachRequestAPI.as_view(),
          name='decline-crew-attach-request-api'),
     path('accept-crew-attach-request-api/',
          AcceptCrewAttachRequestAPI.as_view(),
     ...
     path('like-dislike-replace-html/',
          ProjectVideoLikeDislikeAjaxView.as_view(),
